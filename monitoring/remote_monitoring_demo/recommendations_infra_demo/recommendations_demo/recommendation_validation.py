...
def validate_experiment_recommendations_boxplots_actuals(exp_name, inputfile, validatefile, match_type):
    validate_files = filecmp.cmp(inputfile, validatefile)
    if validate_files:
        print(match_type, " MATCH for ", exp_name)
        exit(0)
    else:
        print(match_type, " DOESN'T MATCH for ",exp_name)
        exit(1)
