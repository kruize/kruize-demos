...
def get_plot_data_csv(filename):
    with open(filename, 'r') as f:
      data = json.load(f)
    if not data:
        print("No experiments found!")
        ...
        with open('experimentPlotData_sorted_temp.csv', 'w', newline='') as csvfile:
            fieldnames = reader.fieldnames
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
            writer.writeheader()
            writer.writerows(data_sorted)
        ...
        os.remove('experimentPlotData_temp.csv')
        os.remove('experimentPlotData_sorted_temp.csv')
